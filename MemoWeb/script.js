...
memoList.addEventListener("click", (e) => {
  ...
  if (selectedParentElement.className === "memoCard") {
    ...
    const selectedMemoId = memoArr.findIndex(
      (element) => element.id === Number(selectedElementId)
    );
...
function editMemo(selectedParentElement, selectedElementId) {
  ...
  const memoEditDoneBtn =
    selectedParentElement.querySelector(".memoEditDoneBtn");
  const memoEditCancelBtn =
    selectedParentElement.querySelector(".memoEditCancelBtn");
